                        ...
                        <div class="col-11">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 form-group">
                                    <input type="text" id="nomor-perkara" class="form-control @error('nomor')is-invalid
                                        @enderror" name="nomor" placeholder="Nomor Perkara">
                                    @error('nomor')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 form-group">
                                    <input type="text" id="pasal-perkara" class="form-control @error('pasal')is-invalid
                                    @enderror" name="pasal" placeholder="pasal">
                                    @error('pasal')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 form-group">
                                    <input type="text" id="klasifikasi-perkara"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 form-group">
                                    <div id="modals">
                                        <div class="modal fade" id="modal-terdakwa-1" tabindex="-1" role="dialog"
                                            aria-labelledby="modalTerdakwaTitle" aria-hidden="true">
                                                                ...
                                                                <div class="row justify-content-center">
                                                                    ...
                                                                    <div class="col-md-7 form-group">
                                                                        <input type="text" id="nama"
                                                                            class="form-control"
                                                                            name="terdakwa[0][nama]" placeholder="Nama">
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <label>Email</label>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-7 form-group">
                                                                        <input type="number" id="usia"
                                                                            class="form-control"
                                                                            name="terdakwa[0][usia]" placeholder="Usia">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
                                            ...
                                            <tr id="row-terdakwa-1">
                                                ...
                                                <td style="width: 40%" class="text-center">
                                                    <button type="button" class="badge bg-success border-0"
                                                        ...
                                                        data-bs-target="#modal-terdakwa-1">Edit</button>
                                                    <button type="button"
                                                        class="badge bg-info border-0 delete-btn" id="add-terdakwa">Tambah</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
